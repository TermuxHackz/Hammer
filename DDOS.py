...
def usage():
 ...
 ةيلاتلا لصاوتلا عقاوم يلع يعم لصاوتلا يف ددرتت ال هلكشم يا تدجو اذإ و

❵ عقوملا قالغا هصرف تداز املك ، همدخلا بجح ةزهجا ددع تداز املك ❴

هنا ملعلا كيلع و همجهلا ءدب لسلست عابتا ءاجرب و :        
ربؤيتويـلا رادنـفلــسأ روطملا ةطساوب اهريوطت و اهئانب و هادالا هذه ريوطت مت و
 اهنع همدخلا بجح و ةينورتكالا عقاوملا يلع موجهلل هادالا هذه عنص مت 

 _____________________________________________________
                    ⚶ contect ⚶
    insta: @aslefndar_wa     whatsapp: +201550746672
    
    youtube ch: @ASLEFNDAR   Telegram: @ASLEFNDAR_WA
_____________________________________________________
